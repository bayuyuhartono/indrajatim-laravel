    ...
    <div class="row row-sm mg-t-15 mg-sm-t-20">
        ...
        <div class="col-md-6 mg-t-15 mg-sm-t-20 mg-md-t-0">
            <div class="card pd-20 pd-sm-40">
                ...
                <p class="mg-b-20 mg-sm-b-30">The stacked charts are used when data sets have to be broken down into
                        ...
                        <tbody>
                            <tr>
                                <td class="pd-l-20 tx-center">
                                    <img src="{{ asset('assets/admin/res') }}/img/img1.jpg" class="wd-36 rounded-circle"
                                        alt="Image">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="pd-l-20 tx-center">
                                    <img src="{{ asset('assets/admin/res') }}/img/img2.jpg" class="wd-36 rounded-circle"
                                        alt="Image">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="pd-l-20 tx-center">
                                    <img src="{{ asset('assets/admin/res') }}/img/img3.jpg" class="wd-36 rounded-circle"
                                        alt="Image">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="pd-l-20 tx-center">
                                    <img src="{{ asset('assets/admin/res') }}/img/img5.jpg" class="wd-36 rounded-circle"
                                        alt="Image">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="pd-l-20 tx-center">
                                    <img src="{{ asset('assets/admin/res') }}/img/img4.jpg" class="wd-36 rounded-circle"
                                        alt="Image">
                                </td>
                                <td>
            ...
            <ul class="list-group widget-list-group bg-info mg-t-20">
                <li class="list-group-item rounded-top-0">
                    <p class="mg-b-0"><i class="fa fa-cube tx-white-7 mg-r-8"></i><strong class="tx-medium">Retina:
                            13.3-inch</strong> <span class="text-muted">Display</span></p>
                </li>
                ...
                <li class="list-group-item">
                    <p class="mg-b-0"><i class="fa fa-cube tx-white-7 mg-r-8"></i><strong class="tx-medium">3.1 GHz
                            Intel Core i7</strong> <span class="text-muted">Processor</span></p>
                </li>
                <li class="list-group-item rounded-bottom-0">
                    <p class="mg-b-0"><i class="fa fa-cube tx-white-7 mg-r-8"></i><strong class="tx-tx-medium">16 GB
                            1867 MHz DDR3</strong> <span class="text-muted">Memory</span></p>
                </li>
            </ul>
        </div><!-- col-4 -->
    </div><!-- row -->
